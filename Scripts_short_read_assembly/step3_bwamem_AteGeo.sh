...
do
	...
	echo "/opt/apps/rhel7/bwa-0.7.17/bwa mem -M -t 4 -p /work/klk37/howler_assembly/AteGeo_genome.fa /dev/stdin | \\" >> $FILE
	...
	echo "R=/work/klk37/howler_assembly/AteGeo_genome.fa CREATE_INDEX=true ADD_MATE_CIGAR=true \\" >> $FILE
